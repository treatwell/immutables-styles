...
/**
 * These patterns are used to instruct Immutables on how to scan for accessor methods (for which to generate fields for the generated class).
 * <p>
 ...
 *
 * @see Style#get()
 * @see ClassNamePatterns for the class-level sibling of this one
 */
